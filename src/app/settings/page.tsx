            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
              ...
              <div className="border-t border-gray-100 pt-3 mt-3">
                <p className="text-xs text-gray-500">
                  Add your LinkedIn profile link to a resume. The new-resume wizard can auto-import your public LinkedIn profile — a Pro feature (name, education, experience, skills).
                </p>
              </div>
            </div>
          </div>
