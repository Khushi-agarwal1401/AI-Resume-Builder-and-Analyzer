...
export function TemplateMiniPreview({ templateId, className }: TemplateMiniPreviewProps) {
  return (
    <div className={cn("w-full h-full rounded-sm overflow-hidden bg-white flex flex-col", className)}>
      ...
      {templateId === "executive-sidebar" && (
        <div className="flex h-full">
          <div className="w-[35%] bg-slate-800 p-1.5 flex flex-col gap-1">
            ...
            <div className="w-full h-0.5 bg-blue-400 rounded" />
          ...
          <div className="w-[65%] p-1.5 flex flex-col gap-1">
      ...
      {templateId === "modern-card" && (
        <div className="p-2 flex flex-col gap-1.5 text-[6px]">
          <div className="bg-white rounded border border-gray-200 p-1.5">
            <div className="w-10 h-1 bg-black rounded mb-0.5" />
            <div className="w-6 h-0.5 bg-gray-300 rounded" />
          </div>
          <div className="bg-white rounded border border-gray-200 p-1.5">
            <div className="w-full h-0.5 bg-indigo-400 rounded mb-0.5" />
          ...
          <div className="bg-white rounded border border-gray-200 p-1.5">
            ...
            <div className="flex flex-wrap gap-0.5 mt-0.5">
              <div className="w-3 h-0.5 bg-indigo-100 rounded" />
              <div className="w-4 h-0.5 bg-indigo-100 rounded" />
              <div className="w-3 h-0.5 bg-indigo-100 rounded" />
            </div>
          </div>
        </div>
