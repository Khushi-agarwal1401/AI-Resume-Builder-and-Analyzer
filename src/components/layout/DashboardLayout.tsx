    ...
    <div className="flex min-h-screen relative pt-[72px] bg-gray-50/30 dark:bg-gray-950">
      ...
      <aside
        ...
        className={cn(
          ...
          "lg:fixed lg:top-[72px] lg:h-[calc(100vh-72px)] lg:inset-y-auto lg:translate-x-0",
      ...
      >
        ...
        <div className="border-t border-gray-100 dark:border-gray-800 px-3 py-3">
          ...
          <button
            onClick={() => signOut()}
            className="flex items-center gap-3 w-full px-3 py-2.5 mt-1 rounded-xl text-[13px] font-medium text-gray-500 hover:text-red-600 hover:bg-red-50 transition-all duration-200 dark:text-gray-400 dark:hover:text-red-400 dark:hover:bg-red-500/10"
          >
      ...
      {/* Main content */}
      <div className="flex-1 min-w-0 lg:pt-0 pb-20 lg:pb-0 lg:ml-[260px]">
        {children}
      </div>
