...
const CRITICAL_VARS: EnvVar[] = [
  ...
  { name: "GROQ_API_KEY", description: "Groq API key (primary AI provider)", critical: false },
  { name: "GEMINI_API_KEY", description: "Google Gemini AI API key (fallback AI provider when Groq is unavailable)", critical: false },
