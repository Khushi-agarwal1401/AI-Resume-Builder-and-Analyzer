...
import type { ResumeData, StyleIntent, StyleSlot } from "@internal/schema/resume/data";
import type { SectionStyleRuleContext } from "@internal/schema/resume/style-rules";
import { getSectionStyleRuleContext, resolveStyleIntentForSlot } from "@internal/schema/resume/style-rules";
import { rgbaStringToHex } from "@internal/utils/color";
