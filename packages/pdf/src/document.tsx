import type { LayoutPage, ResumeData, Typography } from "@internal/schema/resume/data";
import type { Template } from "@internal/schema/templates";
import type { Locale } from "@internal/utils/locale";
